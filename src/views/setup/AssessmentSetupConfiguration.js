...
/**
 * Converted from assessment_setup.html
 * ARP Standard:
...
const AssessmentSetupConfiguration = () => {
          ...
          <CCardBody>
            <CForm>
              <CRow className="g-3">
                ...
                <CCol md={3}><CFormLabel>Upload Assessment Codes</CFormLabel></CCol>
                <CCol md={3}>
                  <ArpButton
...
export default AssessmentSetupConfiguration
